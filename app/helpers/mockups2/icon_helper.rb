  ...
  module IconHelper
    ...
    def lucide_icon(name, **options)
      ...
      icon_paths = {
        ...
        home_simple: '<path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/>',
        ...
        # Finance & Money
        dollar_sign: '<line x1="12" x2="12" y1="2" y2="22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/>',
        trending_up_icon: '<polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/>',
        ...
        shield_check: '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"/><path d="m9 12 2 2 4-4"/>',
        ...
        external_link: '<path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" x2="21" y1="14" y2="3"/>',
      ...
      path = icon_paths[name.to_sym] || icon_paths[:help_circle]
      ...
      content_tag :svg, 
        ...
        class: "lucide lucide-#{name} #{css_class}",
        **options
    end
    
    # Shortcut pour les icons courants
    def icon_utensils(**opts); lucide_icon(:utensils, **opts); end
    def icon_briefcase(**opts); lucide_icon(:briefcase, **opts); end
    def icon_home(**opts); lucide_icon(:home_simple, **opts); end
    def icon_shopping_bag(**opts); lucide_icon(:shopping_bag, **opts); end
    def icon_smartphone(**opts); lucide_icon(:smartphone, **opts); end
    def icon_stethoscope(**opts); lucide_icon(:stethoscope, **opts); end
    def icon_car(**opts); lucide_icon(:car, **opts); end
    def icon_landmark(**opts); lucide_icon(:landmark, **opts); end
    def icon_moon(**opts); lucide_icon(:moon, **opts); end
    def icon_check(**opts); lucide_icon(:check, **opts); end
    def icon_x(**opts); lucide_icon(:x, **opts); end
    def icon_heart(**opts); lucide_icon(:heart, **opts); end
    def icon_star(**opts); lucide_icon(:star, **opts); end
    def icon_bar_chart(**opts); lucide_icon(:bar_chart, **opts); end
    def icon_trending_up(**opts); lucide_icon(:trending_up, **opts); end
    def icon_users(**opts); lucide_icon(:users, **opts); end
    def icon_folder(**opts); lucide_icon(:folder, **opts); end
    def icon_eye(**opts); lucide_icon(:eye, **opts); end
    def icon_message(**opts); lucide_icon(:message_square, **opts); end
  end
end
